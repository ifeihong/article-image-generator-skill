...
- 首次使用引导：逐步引导式专家模式，新用户自动激活
- 错误处理：15+ 种错误场景，每种配有清晰恢复策略
- 风格预览画廊：`assets/style-previews/` 中 10 张预览图
- 风格浏览：说"看看风格效果"即可预览后选择

### v1.2 (2026-06-18)

- 多语言标注支持：自动识别或手动选择（中文/英文/日文/韩文）
- 双工作流模式：快速模式（1步）和专家模式（完整9步）
- 风格混合实验：组合两种画风创造独特视觉效果
- 历史记录与复用：自动保存参数，快捷命令复用
- 系列文章角色延续：保存情境锚定角色跨文章复用
- 配图策略报告：可选生成前认知分析
- 修复 context-anchor.md 角色一致性描述

### v1.1 (2026-06-18)

- 可自定义画幅比例：16:9、9:16、4:3、3:4、1:1、21:9
- 可自定义配图数量：1-9 张（附智能推荐）
- 工作流更新为 9 步（增加画幅和数量选择）
- 增强视觉基因，支持多画幅规范
